...
from datacat4ml.const import HHD_OR_DIR, MHD_OR_DIR, OR_chemblids
...
def curate_ORs():
    ...
    run_curation(ds_level='hhd', input_path=HHD_OR_DIR, output_path=CURA_HHD_OR_DIR,
    ...
    # Binding affinity
    run_curation(ds_level='mhd', input_path=MHD_OR_DIR, output_path= CURA_MHD_OR_DIR,
